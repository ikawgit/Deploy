...
<link rel="stylesheet" type="text/css" href="./pages/easyui/css/demo.css">
<script type="text/javascript" src="./pages/easyui/jquery.min.js"></script>
...
<tr>
 <td height="26" background="./pages/skin/images/newlinebg3.gif">
  ...
  <td>
	...
	<table id="dataList" width='98%'  border='0' cellpadding='1' cellspacing='1' bgcolor='#CBD8AC' align="center" style="margin-top:8px"> 
